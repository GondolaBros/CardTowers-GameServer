...
namespace CardTowers_GameServer.Shine.Util
{
    public class Constants
    {
        ...
        public static string PGSQL_RDS_CONNECTION_STRING = "Host=gb-cardtowers-dev.cerkerng2ucs.us-east-1.rds.amazonaws.com;Username=gbadmin;Password=1#XyT.[Q{[oq82?0?E$6f(vc5$E5;Database=cardtowers-dev;Port=5432;IncludeErrorDetail=true";
    }
}
