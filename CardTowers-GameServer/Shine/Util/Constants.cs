...
namespace CardTowers_GameServer.Shine.Util
{
    public class Constants
    {
        ...
        public static string PGSQL_RDS_CONNECTION_STRING = "Host=gb-cardtowers-dev.cerkerng2ucs.us-east-1.rds.amazonaws.com;Username=gbadmin;Password=<[5ZBS8Y0A+o8hSu[{0v9<3~eix];Database=cardtowers-dev;Port=5432";
    }
}
